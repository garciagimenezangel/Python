...
# INPUT
root = home + '\\Documents\\DATA\\OBServ\\ESYRCE\\PROCESSED\\z30\\metrics\\'

# OUTPUT
outFilename = home + '\\Documents\\DATA\\OBServ\\ESYRCE\\PROCESSED\\z30\\metrics\\data_flag012.csv'

# Get filtered files
listFiles = glob.glob(root+"*.csv")
