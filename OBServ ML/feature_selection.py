...
def evaluate_model_rfe(model, predictors, labels, n_features=50):
    ...
    scores = cross_val_score(model, predictors_reduced, labels, scoring="neg_mean_squared_error", cv=5, n_jobs=-1)
...
if __name__ == '__main__':
    ...
    feature_names = np.array(['bio01', 'bio02', 'bio03', 'bio04', 'bio05', 'bio06', 'bio07',
           ...
           'x0_4.0', 'x0_5.0', 'x0_6.0', 'x0_7.0', 'x0_8.0', 'x0_10.0',
           'x0_12.0'])
    ...
    # rmse = np.sqrt(mse)
    # scores = cross_val_score(model, predictors_reduced, labels, scoring="neg_mean_squared_error", cv=5)
